                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            searchQuery = value; // Update search query when text changes
                          });
                        },
                        decoration: InputDecoration(
                          hintText: 'Search by tracking ID, name, or phone',
                                    ...
                                    child: SingleChildScrollView(
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context, index) {
                                            ...
                                            var parcelItem = parcel.parcelList[index];
                                            if (searchQuery.isNotEmpty &&
                                                !(parcelItem.trackingId.toString().contains(searchQuery) ||
                                                    parcelItem.customerName.toString().toLowerCase().contains(searchQuery.toLowerCase()) ||
                                                    parcelItem.customerPhone.toString().contains(searchQuery))) {
